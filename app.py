...
if whoscored_match_id!="" and fotmob_match_id!="":
    ...
    if fotmobData:
        ...
        with st.sidebar:
            selected_fotmob_player_name, selected_fotmob_player_id = player_select_container.selectbox("Select Fotmob Player", player_options, format_func=lambda x: x[0], index=0)
